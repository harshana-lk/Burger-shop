...
public class PlaceOrderController {
    ...
    public void placeOrderOnAction(ActionEvent actionEvent) {
        Order order1 = new Order(lblOrderID.getText(), txtCustID.getText(), Integer.parseInt(txtQty.getText()), Integer.parseInt(txtBill.getText()), "Preparing");
        Customer c1 = new Customer(txtCustID.getText(), txtCustName.getText());

        boolean isSaved = Database.orderIncrement(order1) != null;
        boolean isSave = Database.custIncrement(c1) != null;
